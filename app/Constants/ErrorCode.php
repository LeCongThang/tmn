...
class ErrorCode
{
    ...
    public static $RequireTab = 216;
    public static $RequireDate = 217;
    public static $RequireCaddyId = 218;
    public static $RequireTimetable = 219;
    public static $RequireComment = 220;
    public static $RequireProvinceId = 221;
    ...
    public static $NotificationRequired= 601;

    public static $NotEnoughBalance = 700;

    public static $CaddyUnavailable = 800;
}
