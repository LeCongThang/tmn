...
function getStatus($stt,$trueText = 'Administrator',$falseText = 'Nhân viên')
{
    if($stt)
        return '<label class="label label-success">'.$trueText.'</label>';
    return '<label class="label label-info">'.$falseText.'</label>';
}
